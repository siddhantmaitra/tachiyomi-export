...
public class App {
    public static void main(String[] args) {
        try {
            ...
            FileInputStream fileInputStream = new FileInputStream("src/main/resources/backup_latest.tachibk");
            ...
            FileOutputStream fileOutputStream = new FileOutputStream("src/main/resources/output02.json");
